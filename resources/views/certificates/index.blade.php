        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                <div class="card-header card-header-text">
                    <h4 class="card-title">Constancias de Estudios</h4>
                    <a href="{{ route('certificates.create') }}" class="btn btn-danger text-white">
                ...
                <div class="card-content table-responsive">
                            ...
                            <tbody>
                                @foreach($certificates as $certificate)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('certificates.preview', $certificate->idcertificate) }}" class="btn btn-info text-white">
                                            ...
                                            @if($certificate->status == 1)
                                                ...
                                                <a href="{{ route('certificates.showDelete', $certificate->idcertificate) }}" class="btn btn-danger text-white">
                    ...
                    @else
                        <div class="alert alert-warning" style="position: relative; margin-top: 14px; margin-bottom: 0px;">
                            <strong>No hay constancias emitidas!</strong>
                        </div>
                    @endif
                </div>
            </div>
